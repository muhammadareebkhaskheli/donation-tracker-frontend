...
export default function Signup() {
  ...
  // Initialize userType with URL parameter or default to 'donor' - ONLY DECLARE ONCE
  ...
  // Benefits data - ALL 4 BENEFITS FOR BOTH
  const benefits = {
    donor: [
      {
        icon: TrendingUp,
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(false);
    console.log("Signup successful:", { ...formData, userType, phoneCode });
  };
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          ...
          <div className="space-y-8 relative z-10">
            ...
            {/* Benefits Grid - NOW SHOWING ALL 4 BENEFITS */}
            <motion.div
              variants={staggerContainer}
        ...
        >
          ...
          >
            ...
            {/* Mobile Benefits Section - NOW SHOWING ALL 4 BENEFITS ON MOBILE */}
            <motion.div
              variants={fadeInUp}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Confirm Password - FIXED: Eye button positioning */}
              <motion.div
                variants={fadeInUp}
              >
                <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              {/* Terms Checkbox with Enhanced Animations */}
              <motion.div
                variants={fadeInUp}
              ...
              {/* Submit Button - FIXED: Removed duplicate variants attribute */}
              <motion.button
                variants={fadeInUp}
                type="submit"
                disabled={isLoading}
